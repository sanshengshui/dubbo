...
public class JavassistCompiler extends AbstractCompiler {
    ...
    public Class<?> doCompile(String name, String source) throws Throwable {
        ...
        List<String> importPackages = new ArrayList<String>();//引用报名
        Map<String, String> fullNames = new HashMap<String, String>();//引用类名
        while (matcher.find()) {
        ...
        // 生成类
        // JavassistCompiler.class.getProtectionDomain() =》 设置保护域和 JavassistCompiler 一致，即 `#getClass()` 方法。深入见
